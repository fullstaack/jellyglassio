...
$mail->Username = 'rksagi@jellyglass.io';             // SMTP username
$mail->Password = '7gearUp4';                           // SMTP password
$mail->SMTPSecure = 'SSL';
$mail->Port = 465;                                    // TCP port to connect to
// Add the address to send the mail to
$mail->AddAddress('rksagi@jellyglass.io');
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->IsHTML(true);                                  // Set email format to HTML

// add your company name here
$company_name = 'Jelly Glass Software Pvt. Ltd.';
